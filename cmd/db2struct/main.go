...
var schemaAnnotation = goopt.Flag([]string{"--schema"}, []string{}, "Add schema annotations (tags)", "")
...
func main() {
	...
	struc, err := db2struct.Generate(*columnDataTypes, columnsSorted, *mariadbTable, *structName, *packageName, *jsonAnnotation, *gormAnnotation, *gureguTypes, *schemaAnnotation)
